...
const TOC = [
  ...
  { href: '#estrategias',  label: 'Estrategias generales' },
  { href: '#escenarios',   label: 'Escenarios de recuperación' },
  { href: '#roles',        label: 'Roles y responsabilidades' },
  { href: '#comunicacion', label: 'Plan de comunicación' },
  { href: '#pruebas',      label: 'Pruebas y mantenimiento' },
      ...
      <div className="doc-wrap" style={{ paddingTop:56, paddingBottom:56 }} ref={scrollRef}>
        <div className="doc-withtoc">
          ...
          <main style={{ minWidth:0 }}>
            ...
            {/* 11.4 Estrategias */}
            <section id="estrategias" style={{ scrollMarginTop:16, marginBottom:56 }}>
            ...
            {/* 11.5 Escenarios */}
            <section id="escenarios" style={{ scrollMarginTop:16, marginBottom:56 }}>
            ...
            {/* 11.6 Roles */}
            <section id="roles" style={{ scrollMarginTop:16, marginBottom:56 }}>
            ...
            {/* 11.7 Comunicación */}
            <section id="comunicacion" style={{ scrollMarginTop:16, marginBottom:56 }}>
            ...
            {/* 11.8 Pruebas */}
            <section id="pruebas" style={{ scrollMarginTop:16, marginBottom:56 }}>
            ...
            {/* 11.9 Conclusiones */}
            <section id="conclusiones" style={{ scrollMarginTop:16 }}>
