// PDF download links keyed by document ID.
// Add a URL here whenever a new PDF becomes available.
export const PDF_LINKS: Record<string, string> = {
  'MC-01':  'https://drive.google.com/uc?export=download&id=1hD6mySW7k231eTNXiJRd87aLnNpW4a6g',
  'MIT-02': 'https://drive.google.com/uc?export=download&id=15ZPX3ziMmFuYPlS5EG461C9ZANurE2U7',
  'CG-03':  'https://drive.google.com/uc?export=download&id=1HJKVqfbHLVU1gNtlAKC9v-yN6Y-fLcCj',
  'ME-04':  'https://drive.google.com/uc?export=download&id=1foctRNjvJnn9clcy20hdEcPaPFrA-UOJ',
